...
<head>
    ...
    <style>
        ...
        .noon-yellow { background-color: #feee00; }
    ...
    <div x-data="{
        ...
        <div class="relative bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <div class="relative h-64 bg-white overflow-hidden">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-noon-navy via-noon-navy to-transparent opacity-90"></div>
            </div>
                ...
                <form method="POST" action="{{ route('auth.handle') }}">
                    ...
                    <div x-show="step === 1">
                        ...
                        <div class="relative my-8 border-t border-gray-100">
                            <span class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-gray-400 text-xs uppercase">OR</span>
                        </div>

                        <!-- Social Buttons -->
                        <div class="space-y-3">
                            <a href="/auth/google/redirect" class="flex items-center justify-center w-full border border-gray-300 py-3 rounded-lg hover:bg-gray-50 font-semibold text-gray-600">
                                <img src="https://img.icons8.com/color/24/google-logo.png" class="mr-3"> Sign in with Google
                            </a>
                            <a href="/auth/facebook/redirect" class="flex items-center justify-center w-full border border-gray-300 py-3 rounded-lg hover:bg-gray-50 font-semibold text-gray-600">
                                <img src="https://img.icons8.com/color/24/facebook-new.png" class="mr-3"> Sign in with Facebook
                            </a>
                        </div>
                    </div>
                    ...
                    <div x-show="step === 2" x-cloak>
                        <p class="text-sm text-gray-500 mb-4">Entering <span x-text="mode"></span> info for: <span class="font-bold text-gray-800" x-text="email"></span></p>

                        <div class="relative border rounded-lg px-4 py-3 mb-4 focus-within:ring-2 focus-within:ring-blue-400">
                            <label class="absolute -top-2.5 left-3 bg-white px-1 text-xs text-gray-500 font-semibold">Password*</label>
                            <input type="password" x-model="password" name="password" class="w-full outline-none text-gray-700">
                        </div>

                        <template x-if="mode === 'signup'">
                            <div class="relative border rounded-lg px-4 py-3 mb-4 focus-within:ring-2 focus-within:ring-blue-400">
                                <label class="absolute -top-2.5 left-3 bg-white px-1 text-xs text-gray-500 font-semibold">Confirm Password*</label>
                                <input type="password" x-model="confirm_password" name="password_confirmation" class="w-full outline-none text-gray-700">
                            </div>
                        </template>
